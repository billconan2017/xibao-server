...
function seedDefaults() {
  ...
  upgradeDefault.run('2.3.0', 'client_version', '1.0.1');
  upgradeDefault.run('2.3.0', 'version', '1.1.0');
  upgradeDefault.run('2.3.0', 'version', '2.0.0');
  upgradeDefault.run('2.3.0', 'version', '2.1.0');
  upgradeDefault.run('2.3.0', 'version', '2.2.0');
}
